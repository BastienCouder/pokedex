...
const buttonStyles = tv(
    {
        ...
        variants: {
            variant: {
                ...
                quiet: 'bg-transparent hover:bg-neutral/10 active:bg-neutral/20 text-foreground',
                ...
                danger: 'bg-destructive hover:bg-destructive  active:bg-destructive text-destructive-foreground',
            },
            size: {
